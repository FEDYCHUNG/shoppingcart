...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: asset('{{ asset('frontend/login/images/bg-01.jpg') }}');">
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="post" action="{{ route('create_account') }}">
                    @csrf
                    <a href="{{ url('/') }}">
